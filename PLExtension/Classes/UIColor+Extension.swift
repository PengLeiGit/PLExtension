...
extension UIColor {
     ...
     * RGB颜色 不用除以255
     */
    public static func pl_RGB(r: CGFloat, g: CGFloat, b: CGFloat) -> UIColor {
     ...
     * 如果是6位，默认是不透明。
     */
    public class func pl_hex(hex: String, alpha: CGFloat = 1.0) -> UIColor {
...
extension UIColor {
     ...
     * 通过颜色生成图片
     */
    public func pl_makeImage() -> UIImage {
...
extension UIColor {
    /// 黑灰色 0x333333
    public static var pl_darkGray: UIColor = UIColor.pl_hex(hex: "0x333333")
    /// 灰色  0x666666
    public static var pl_gray: UIColor = UIColor.pl_hex(hex: "0x666666")
    /// 浅灰色 0x999999
    public static var pl_lightGray: UIColor = UIColor.pl_hex(hex: "0x999999")
    /// 提示文字色 0xCCCCCC
    public static var pl_prompt: UIColor = UIColor.pl_hex(hex: "0xCCCCCC")
    /// 分割线 0xEEEEEE 所有的tablView,collectionView的分割线
    public static var pl_line: UIColor = UIColor.pl_hex(hex: "0xEEEEEE")
    /// 背景色 0xF5F5F5
    public static var pl_backgroud: UIColor = UIColor.pl_hex(hex: "0xF5F5F5")
}
...
extension CAGradientLayer {
     ...
     */
    public func pl_makeLayer(colors: [UIColor], direction: CAGradientDirection = .horizontal, locations: [NSNumber] = []) {
