...
extension UIImage {
    ...
    /// - Returns: 重设的图片
    public func pl_resize(newSize: CGSize) -> UIImage {
    ...
    /// - Returns: 获得等比例的size
    public func pl_zoomByMaxSide(_ maxSide: CGFloat) -> CGSize {
     ...
     * 裁切指定区域（CGRect）获取图片
     */
    public func pl_cropByRect(_ rect:CGRect) -> UIImage {
...
extension UIImage {
     ...
     * 修复图片旋转
     */
    public func pl_repairOrientation() -> UIImage {
...
extension UIImage {
    ...
    /// 1:1 占位图
    public static let pl_placeholder_1x1 = Placeholder_1x1()
    /// 2:1 占位图
    public static let pl_placeholder_2x1 = Placeholder_2x1()
    /// 3:1 占位图
    public static let pl_placeholder_3x1 = Placeholder_3x1()
    /// 3:2 占位图
    ...
    ///   - bgColor: 生成的图片背景颜色
    /// - Returns: 图片
    public static func pl_placeholder (
