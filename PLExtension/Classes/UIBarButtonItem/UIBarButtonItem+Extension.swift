...
extension UIBarButtonItem {
    ...
    public static func pl_setImage(_ image: UIImage?, target: UIViewController, selector: Selector, isLeft: Bool = false) -> UIBarButtonItem {
    ...
    /// - Returns: UIBarButtonItem
    public static func pl_setText(_ text: String, textColor: UIColor = UIColor.darkText, font: CGFloat = 14, target: UIViewController, selector: Selector, isLeft : Bool = false) -> UIBarButtonItem {
